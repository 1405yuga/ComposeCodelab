...
@Composable
fun ReplyHomeScreen(
    navigationType: ReplyAppNavigationType,
    contentType: ReplyAppContentType,
    ...
    if (navigationType == ReplyAppNavigationType.PERMANENT_NAVIGATION_DRAWER && replyUiState.isShowingHomepage) {
...
private fun ReplyAppContent(
    ...
    Box(modifier = modifier) {
        ...
        AnimatedVisibility(visible = navigationType == ReplyAppNavigationType.NAVIGATION_RAIL) {
            ReplyNavigationRail(
        ...
        Column(
            ...
            if (contentType == ReplyAppContentType.LIST_AND_DETAIL) {
            ...
            AnimatedVisibility(visible = navigationType == ReplyAppNavigationType.BOTTOM_NAVIGATION) {
